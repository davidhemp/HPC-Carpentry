...
Today, people coding or analysing data typically work with laptops.
 ...
 ![A standard laptop]({{ site.url }}{{ site.baseurl }}/fig/200px-laptop-openclipartorg-aoguerrero.svg)
...
![Schematic of how a computer works]({{ site.url }}{{ site.baseurl }}/fig/Simple_Von_Neumann_Architecture.svg)
